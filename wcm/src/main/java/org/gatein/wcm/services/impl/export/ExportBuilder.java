...
public class ExportBuilder {
    ...
    private void add(Comment c) {
        comments.append("<comment>")
                .append("\n")
                    ...
                    .append("\n")
                    .append("<content>").append("<![CDATA[").append(c.getContent()).append("]]>").append("</content>")
                    .append("\n")
    ...
    private void add(Post p) {
        posts.append("<post>")
             .append("\n")
                ...
                .append("\n")
                .append("<excerpt>").append("<![CDATA[").append(p.getExcerpt()).append("]]>").append("</excerpt>")
                .append("\n")
                ...
                .append("\n")
                .append("<comment-status>").append(p.getCommentsStatus()).append("</comment-status>")
                .append("\n")
                .append("<title>").append("<![CDATA[").append(p.getTitle()).append("]]>").append("</title>")
                .append("\n")
    ...
    private void add(Template t) {
        templates.append("<template>")
                ...
                .append("\n")
                .append("<name>").append("<![CDATA[").append(t.getName()).append("]]>").append("</name>")
                .append("\n")
    ...
    private void add(Upload u) {
        uploads.append("<upload>")
                ...
                .append("\n")
                .append("<description>").append("<![CDATA[").append(u.getDescription()).append("]]>").append("</description>")
                .append("\n")
                .append("<filename>").append("<![CDATA[").append(u.getFileName()).append("]]>").append("</filename>")
                .append("\n")
