...
//
//                // Reading content
//                WCMObject c1 = cs.getContent("/bintest" + nTest + "/jbossportletbridge", "en");
//                WCMObject c2 = cs.getContent("/bintest" + nTest + "/wcm-whiteboard", "en");
//
//                if (c1 instanceof WCMBinaryDocument) {
//                    WCMBinaryDocument b1 = (WCMBinaryDocument)c1;
...
//                }
//
//                if (c2 instanceof WCMBinaryDocument) {
//                    WCMBinaryDocument b2 = (WCMBinaryDocument)c2;
