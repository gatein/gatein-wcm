...
public interface ContentService {
	 ...
	 * @throws ContentException if the id exists in the repository (then user should use updateSimpleContent to create a new version).
	 ...
	 */
	public List<Content> getContent(String location, String locale)
		throws ContentException, ContentIOException, ContentSecurityException;
	 ...
	 * @throws ContentSecurityException if user has not been granted to create categories.
	 */
	public List<Content> getContent(List<Category> categories, String location, String locale)
		throws ContentException, ContentIOException, ContentSecurityException; 
	 ...
	 * Context:
	 * 
	 *  - A user with rights can define new ACE and ACL for content.
	 *  - Admin user is defined at configuration level.
	 *  
	 */
	 ...
	 *
	 * Context:
	 *  - CRUD operations over content modified implicitly version of the content.
	 *  - Also a User can explicitly work with versioning updating 
	 * 
	 */
	 ...
	 * @throws ContentSecurityException if user has not been granted to access content under specified location.
	 */
	public List<Integer> getContentVersions(String location, String locale)
		throws ContentException, ContentIOException, ContentSecurityException;
	 ...
	 */
	public List<Content> checkOut(String location, String locale, Integer version)
		throws ContentException, ContentIOException, ContentSecurityException;
	 ...
	 * <p><b>modifyContent(Content)</b><br>
	 * <li>Every user with rights can get a Content and modify.
	 * <li>Each time user write on the content it creates a new version.
	 * <li>Two users can get same content, write at same time, last one, will update the content.</p>
	 * <p><b>checkOutContent(Content)</b><br>
	 ...
	 */
	public Content checkIn(Content content)
		throws ContentException, ContentIOException, ContentSecurityException;
	 ...
	 * @throws ContentSecurityException if user has not been granted to access content under specified location.
	 */
	public List<Content> getContent(String location, String locale, Integer version)
		throws ContentException, ContentIOException, ContentSecurityException;
	 ...
	 * Differences between: <br>
	 * <p><b>removeContent(String, String)</b>
	 * <li>Remove all versions for a given locale.</p>
	 * <p><b>removeContent(String, String, Integer)</b>
	 * <li>Remove just version specified for a given locale.</p>
	 * 
	 * @param location - Location where the content is stored. <br>
	 * String with format: / &lt;id&gt; / &lt;id&gt; / &lt;id&gt; <br>
	 * where "/" is the root of repository and &lt;id&gt; folders ID
	...
	public void closeSession()
		throws ContentException, ContentIOException;
}
