 ...
 * are better represented with {@link WCMBinaryDocument}. <br />
 *
 * BinaryDocument objects represent files that are served by WCM UI without preprocessing. <br />
 *
...
public interface WCMTextDocument extends WCMObject {
    ...
    /**
     *
     * @param content Update content of the TextDocument
     */
