...
public interface WcmRepositoryService {
     ...
     */
    WcmContentService createContentSession(String idRepository, String idWorkspace, String user, String password)
            throws WcmContentIOException, WcmContentSecurityException;

    WcmPublishService createPublishSession(String idRepository, String idWorkspace, String user, String password)
            throws WcmContentIOException, WcmContentSecurityException;
